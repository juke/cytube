...
*/
    ...
    socket.on('queue', function(data) {
        ...
        var msg='<span class="av-queue"><span class="av-queueby">' + data.item.queueby + '</span>' +
                ' added ' +
                '<span class="av-title">' + TITLE + '</span> to the playlist</span>';
		...
		*/
        ...
        if (localStorage.getItem("noty") == "yes") {
		new Noty({
			type: 'info',
			text: msg,
			container: ".noticey",
